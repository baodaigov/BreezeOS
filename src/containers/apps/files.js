...
export const FilesApp = () => {
  ...
  useEffect(() => {
    if (isActive) {
      ...
      document
        .getElementsByClassName("FilesApp")[0]
...
export default function Files() {
  ...
  const FilesWindow = () => {
    ...
    const [directory, setDirectory] = useState(`/home/${settings.user.name}`);
          ...
          return (
            <div className="FilesSection2">
              <div
                ...
                onDoubleClick={() =>
                  setDirectory(
                    "/usr/lib64/systemd/system-environment-generators"
                  )
                }
              >
                <img
          ...
          return (
            <div className="FilesSection2">
              <div
                className="FilesItem"
                onDoubleClick={() =>
                  setDirectory(`/home/${settings.user.name}`)
                }
              >
                <img
                  className="FilesIcon"
          ...
          return (
            <div className="FilesSection2">
              <div
                ...
                onDoubleClick={() =>
                  setDirectory(
                    `/home/${settings.user.name}/Pictures/Screenshots`
                  )
                }
              >
                <img
  ...
  return (
    <div className="FilesWindow">
      <div className="Window files" key={Math.random()}>
        <FilesWindow />
      </div>
    </div>
  );
